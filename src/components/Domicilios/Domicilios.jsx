...
import {
  addNewDomicilio,
  deleteOneDomicilioSelect,
  saveIdsDom,
  selectedOption,
  selectedOptionBarrio,
  selectedOptionDpto,
...
const Domicilios = ({
  ...
  const provinciaSelected = useSelector(
    (state) => state.domiciliosStates.provinciaSelected
  );
  const departamentoSelected = useSelector(
    (state) => state.domiciliosStates.departamentoSelected
  );
  const localidadSelected = useSelector(
    (state) => state.domiciliosStates.localidadSelected
  );
  const domicilioDelEmpleado = useSelector(
    (state) => state.domiciliosStates.idDomicilioSelected
  );
  ...
  const arrayDepartamentos =
    ...
    generalStateData.departamentos !== undefined &&
    generalStateData.departamentos !== ""
      ? generalStateData.departamentos.filter(
          (departamento) =>
            departamento.idProvincia === provinciaSelected.payload.idProvincia
        )
      : null;
  ...
  const arrayLocalidades =
    ...
    generalStateData.localidades !== undefined &&
    generalStateData.localidades !== ""
      ? generalStateData.localidades.filter(
          (localidad) =>
            localidad.idDepartamento ===
            departamentoSelected.payload.idDepartamento
        )
      : null;
  ...
  const arrayBarrios =
    ...
    generalStateData.barrios !== undefined &&
    generalStateData.barrios !== ""
      ? generalStateData.barrios.filter(
          (barrio) =>
            barrio.idLocalidad === localidadSelected.payload.idLocalidad
        )
      : null;
  ...
  const sendDataDomicilios = async () => {
    try {
      await axios
        .post(urlDomicilios, bodyCreateDomicilio, {
          headers: {
            ...
            <section className="">
              <div className="row">
                <div className="col-xl-6 col-lg-6 col-md-6">
                  <div className="mt-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleChangePredeterminado(e, "inputPredeterminado")
                      }
                    />
                  ...
                  <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6">
                      <InputCbo
                        ...
                        value={
                          formDomicilios?.inputCalleDomicilios
                            ? formDomicilios?.inputCalleDomicilios
                            : empleadoUno.calle
                        }
                        ...
                        propArray={
                          empleadoDomicilio !== undefined &&
                          empleadoDomicilio !== null
                            ? empleadoDomicilio.idCalle
                            : null
                        }
                        idSelected={
                          formDomicilios?.inputCalleDomicilios
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 colTapaModal">
                      <InputNumero
                        ...
                        onChange={onChangeValues}
                        inputValueState={
                          formDomicilios?.inputNumCalle
                            ? formDomicilios?.inputNumCalle
                            : empleadoUno.nroCalle
                        }
                      />
                    </div>
                  </div>
                  <InputFormPiso
                    value={
                      formDomicilios?.inputPisoCalle
                        ? formDomicilios?.inputPisoCalle
                        : empleadoUno.pisoCalle
                    }
                ...
                <div className="col-xl-5 col-lg-5 col-md-5 mx-4 gy-4 py-2">
                  <InputCbo
                    value={
                      formDomicilios?.inputProvinciaDomicilios
                        ? formDomicilios?.inputProvinciaDomicilios
                        : empleadoUno.provincia
                    }
                    action={ADD_DOMICILIOS}
                    handleClickRef={handleClickRef}
                    ...
                    nameLabel="Provincia"
                    array={
                      generalStateData.provincias !== undefined &&
                      generalStateData.provincias !== ""
                        ? generalStateData.provincias
                        : []
                    }
                  ...
                  <InputCbo
                    value={
                      formDomicilios?.inputDepartamentosDomicilios
                        ? formDomicilios?.inputDepartamentosDomicilios
                        : empleadoUno.departamento
                    }
                    action={ADD_DOMICILIOS}
                    handleClickRef={handleClickRef}
                    referencia={referencia.pldbRef}
                  ...
                  <InputCbo
                    value={
                      formDomicilios?.inputLocalidadesDomicilios
                        ? formDomicilios?.inputLocalidadesDomicilios
                        : empleadoUno.localidad
                    }
                    action={ADD_DOMICILIOS}
                    handleClickRef={handleClickRef}
                    referencia={referencia.pldbRef}
                    ...
                    nameLabel="Localidad"
                    array={
                      arrayLocalidades !== undefined &&
                      arrayLocalidades !== null
                        ? arrayLocalidades
                        : []
                    }
                  ...
                  <InputCbo
                    value={
                      formDomicilios?.inputBarriosDomicilios
                        ? formDomicilios?.inputBarriosDomicilios
                        : empleadoUno.barrio
                    }
                    action={ADD_DOMICILIOS}
                    ...
                    nameLabel="Barrio"
                    array={
                      arrayBarrios !== undefined && arrayBarrios !== null
                        ? arrayBarrios
                        : []
                    }
                    propArrayOp="barrio"
                ...
                <Buttons
                  idElimiar={domicilioDelEmpleado}
                  refetch={refetch}
                  setRefectch={setRefectch}
                  disabled={disabled}
                  functionSend={sendDataDomicilios}
                  functionDelete={deleteDomicilio}
                  cancelar="cancelar"
                  aceptar="aceptar"
                />
                <TablaDomicilios
