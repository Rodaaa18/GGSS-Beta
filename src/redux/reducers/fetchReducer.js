import {
  ...
  AXIOS_ERROR,
  SET_LOADING,
  ADD_TAREASDESEMPEÑADAS,
  ADD_PARENTESCOS,
  ADD_FORMASPAGO,
  ADD_MODOSCONTRATACION,
  ADD_MODOSLIQUIDACION,
  ADD_EMPLEADORES,
  ADD_DOMICLIOS,
  ADD_CALLES,
  ADD_DEPARTAMENTOS,
  ...
  ADD_NEW_DOC,
  DELETE_DOC,
  ADD_ADIC_LIQUIDACION,
  ADD_ONE_DE,
  DELETE_DOMICILIO,
  SAVE_DATOS_EXTRAS_EMPLEADOS,
  DELETE_DATO_EXTRA_EMP,
  ACTUALIZA_DELETE,
  ACTUALIZA_DELETE_FORMAS_PAGO,
  ACTUALIZA_MODIFICAR_ESCI,
  ACTUALIZA_CREATE_FORMAS_PAGO,
  ACTUALIZA_UPDATE_FORMAS_PAGO,
  ...
  switch (action.type) {
    ...
    case DELETE_DOMICILIO: {
      return {
        ...
        domicilios:
          state.domicilios &&
          state.domicilios.filter((dom) => dom.idDomicilio !== action.payload),
      };
    }
    case ADD_CALLES: {
      return {
    ...
    case DELETE_ONE_FAMILIAR: {
      return {
        ...state.familiares,
        familiares: state.familiares.filter(
          (fam) => fam.iDfamiliares !== action.payload
        ),
      };
    }
    case ADD_CONVENIOS: {
    ...
    case ACTUALIZA_DELETE: {
      return {
        ...
        estadosCiviles:
          state.estadosCiviles &&
          state.estadosCiviles.filter(
            (estadoCivil) => estadoCivil.idEstadoCivil !== action.payload
          ),
      };
    }
    // case ACTUALIZA_MODIFICAR_ESCI: {
    //     return {
    //       ...state,
    //       estadosCiviles:
    //         state.estadosCiviles &&
    ...
    case ACTUALIZA_DELETE_FORMAS_PAGO: {
      const id = state.formasDePago.findIndex((item)=> item.iDformadePago === action.payload.iDformadePago)
