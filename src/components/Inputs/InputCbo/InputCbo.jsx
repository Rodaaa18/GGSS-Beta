    ...
    <div className={`${clasess.classOne}`}>
      <div className={`${clasess.classTwo}`}>
        <div className={`${clasess.classThree}`}>
          <label className={`${clasess.classFour}`} htmlFor="legajo">
            {nameLabel}
          </label>
        </div>
        ...
        {esCalle && (
          <div className="tercero">
            <button
              disabled={disabled}
              className=" btnModalDp btn btn-outline-danger btn-sm "
              onClick={(e) => handleClickRef(e, referencia, modalName)}
            >
              ...
            </button>
          </div>
