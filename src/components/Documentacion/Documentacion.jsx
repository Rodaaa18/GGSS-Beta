...
import {
  classesDateDocs,
  inputButtonClasess,
  inputButtonClasessDocumentacion,
...
const Documentacion = ({
  ...
  const documentacionSeleccionada = useSelector(
    (state) => state.documentacionState.documentacionSeleccionada
  );
  const urlArchivosAdjuntos = `http://54.243.192.82/api/ArchivosDocumentacionEmpleados/${empleadoUno?.iDempleado}`;

  const archivosAdjuntosEmpleado = useSelector(
    (state) => state.documentacionState.archivosAdjuntosEmpleado
  );
  ...
  const documentacionEmpleados = useSelector(
    (state) => state.generalState.documentacionEmpleados
  );

  const documentaciones = useSelector(
    (state) => state.documentacionState.domiciliosDelEmpleado
  );
  ...
  const documentacionDelEmpleado = useSelector(
    (state) => state.documentacionState.documentacionDelEmpleado
  );
  ...
  let bodyPetition = {
    ...
    fechaVencimiento: formDocumentacion?.inputDateVencimiento
      ? formDocumentacion?.inputDateVencimiento
      : null,
    ...
    if (empleadoUno.iDempleado && empleadoUno.iDempleado) {
      setBody(
        (documentacionEmpleados &&
          documentacionEmpleados[documentacionEmpleados.length - 1] !==
            undefined &&
          documentacionEmpleados[documentacionEmpleados.length - 1]
            .idEmpleadoDocumentacion) + 1
      );
      try {
        axios.post(urlPost, bodyPetition).then((res) => {
          if (res.status === 200) {
      ...
      <div className="row">
        ...
        <div className="col-xl-12">
          <InputDate
            ...
            valueCheck={
              formDocumentacion?.inputCheckDocusDate &&
              formDocumentacion?.inputCheckDocusDate
            }
        ...
        <div className="col-xl-12">
          <InputButtonLiquidacion
            ...
            action={GET_INPUT_VALUE}
            value={
              formDocumentacion?.inputSelectDocumentacion &&
              formDocumentacion?.inputSelectDocumentacion
            }
            disabled={disable}
          />
        ...
        <div className="col-xl-12">
          <TextArea
            ...
            value={
              formDocumentacion?.textAreaDocumentacion &&
              formDocumentacion?.textAreaDocumentacion
            }
            disabled={disable}
          />
        ...
        <div className="col-xl-12 contDocumentacion">
          <CheckLabel
            ...
            action={GET_INPUT_VALUE}
            value={
              formDocumentacion?.inputCheckLiquidacion &&
              formDocumentacion?.inputCheckLiquidacion
            }
            disabled={disable}
          />
        ...
        <div className="col-xl-12 contDocumentacion">
          <CheckLabel
            ...
            action={GET_INPUT_VALUE}
            value={
              formDocumentacion?.inputIncluirCuotaAlim &&
              formDocumentacion?.inputIncluirCuotaAlim
            }
            disabled={disable}
          />
        ...
        <div className="col-xl-12 contDocumentacion">
          <Buttons
            ...
            aceptar="aceptar"
            idElimiar={
              documentacionSeleccionada.idEmpleadoDocumentacion &&
              documentacionSeleccionada.idEmpleadoDocumentacion
            }
