...
const NavbarMenu = ({ setTokenDef, sePerfilesUSuario, perfilesUsuario }) => {
  ...
  async function sendModalData(url, body, bodyUpdate, id) {
    if (modify) {
      try {
        await axios.put(`${url}/${id}`, bodyUpdate).then((res) => {
          if (res.status === 200) {
            dispatch(setRefetch(!refetch));
            setModify(false);
            setDisableMOdal(true);
            dispatch(actualizaModificarFormasdePago(id));
            dispatch(actualizaModificarCargos(id));
            dispatch(actualizaModificarTareas(id));
                        ...
                        <li>
                          ...
                          >
                            <ChildModalOptions
                              ...
                              disableModal={disableModal}
                              setDisableMOdal={setDisableMOdal}
                              actualizaDeleteCargos={actualizaDeleteCargos}
                              actualizaCreaCargos={actualizaCreaCargos}
                              actualizaModificarCargos={
                                actualizaModificarCargos
                              }
                              disableModalButtons={disableModalButtons}
                        ...
                        <li>
                          ...
                          >
                            <ChildModalOptions
                              ...
                              disableModal={disableModal}
                              setDisableMOdal={setDisableMOdal}
                              actualizaDeleteTareas={actualizaDeleteTareas}
                              actualizaCreaTareas={actualizaCreaTareas}
                              actualizaModificarTareas={
                                actualizaModificarTareas
                              }
                              disableModalButtons={disableModalButtons}
                        ...
                        <li>
                          ...
                          >
                            <ModalParentesco
                              ...
                              actualizaCreaParentesco={actualizaCreaParentesco}
                              actualizaModificarParentesco={
                                actualizaModificarParentesco
                              }
                            />
                        ...
                        <li>
                          ...
                          >
                            <ModalPaises
                              ...
                              disableModalButtons={disableModalButtons}
                              setDisableModalButtons={setDisableModalButtons}
							  actualizaDeletePaises={actualizaDeletePaises}
							  actualizaCreaPaises={actualizaCreaPaises}
							  actualizaModificarPaises={actualizaModificarPaises}
                              // usaEstados={true}
                              // nameInputCheck="Genera Asignación"
                              // nameInputCheckTwo="Deduce Ganancias"
                              // nameLabelValorDeduccion="Importe"
