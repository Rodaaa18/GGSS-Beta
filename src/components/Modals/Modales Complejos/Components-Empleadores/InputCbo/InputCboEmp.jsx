...
import "./InputCboEmp.css";

export const InputCboEmp = ({
  nameLabel,
  array,
  value,
  display,
        ...
        <div className="form__grupo__label__inp">
          ...
          <div className="segundo">
            <select
              className={
                obligatorio
                  ? "formulario-input-Empleadores form-select ml-0 px-0 obligatorio"
                  : "formulario-input-Empleadores form-select ml-0 px-0"
              }
