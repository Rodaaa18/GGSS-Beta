...
const ChildModalReincorporacion = ({
  handleClickClose,
  nameModalProp,
  nameModal,
  disableModalButtons,
  ...
  const motivosEgreso = useSelector(
        ...
        <div className="row w-100 bodyBajaEmpleado">
          <div className="col-12">
            <fieldset className="border p-2">
              <legend className="float-none w-auto p-2 contenedorFieldSet">
                ...
                <span className="ms-1 d-none d-sm-inline colorFont">
                  Empleado
                </span>
              </legend>
              <div className="row">
              ...
              <div className="row">
                <div className="col-12 d-flex flex-row align-items-center justify-content-start">
                  <label
                    className="labelModalBaja"
                    htmlFor="apellidoNombreModal"
                  >
                    Apellido y Nombre:
                  </label>
                  <input
                    className="inputModalBaja"
                    type="text"
                    name="apellidoNombreModal"
                    id="apellidoNombreModal"
                    value={
                      empleadoUno?.iDempleado
                        ? `${empleadoUno?.apellido}, ${empleadoUno?.nombres}`
                        : ""
                    }
                  />
                </div>
              ...
              <div className="row">
                <div className="col-12 d-flex flex-row align-items-center justify-content-start">
                  <label className="labelModalBaja" htmlFor="cuilModal">
                    CUIL:
                  </label>
                  <input
                    className="inputModalBaja"
                    ...
                    name="cuilModal"
                    id="cuilModal"
                    value={empleadoUno?.iDempleado ? empleadoUno?.cuil : ""}
                  />
                </div>
              </div>
            </fieldset>
          ...
          <div className="col-12">
            <fieldset className="border p-2">
              <legend className="float-none w-auto p-2 contenedorFieldSet">
                <i className="fs-5 bi-person "></i>
                <span className="ms-1 d-none d-sm-inline colorFont">Datos</span>
              </legend>
              <div className="row d-flex flex-row align-items-center justify-content-start">
                <div className="col-6 ">
                  <label
                    className="labelModalBaja"
                    htmlFor="fechaPresentacionReincorpora"
                  >
                    Fecha Presentación:
                  </label>
                  <input
                    onChange={(e) =>
                      onChangeValues(
                        e.target.value,
                        "fechaPresentacionReincorpora"
                      )
                    }
                    value={value?.datePResentacionBaja}
                    className="fechaModalBaja"
                    type="date"
                    name="fechaPresentacionReincorpora"
                    id="fechaPresentacionReincorpora"
                  />
                </div>
              </div>
              <div className="row">
                <div className="col-12 d-flex flex-row align-items-center justify-content-start mt-2">
                  <label
                    className="labelModalBaja"
                    htmlFor="cboReincorporacion"
                  >
                    Documentación:
                  </label>
                  <select
                    onChange={(e) =>
                      onChangeValues(e.target.value, "cboReincorporacion")
                    }
                    className="selectModalBaja"
                    name="cboReincorporacion"
                    id="cboReincorporacion"
                  >
                    {documentaciones &&
                      documentaciones.map((item, index) => {
                        return (
                          <option key={index} value={item.idDocumentacion}>
                            {item.documentacion1}
                          </option>
                        );
                      })}
              ...
              <div className="row">
                <TextArea
                  ...
                  idInput="txtReincorporacion"
                  characterLimit={255}
                  value={value?.txtReincorporacion}
                />
              </div>
            </fieldset>
            <div className="row">
              <div className="col-12 d-flex flex-row-reverse">
                <button
                  ...
                  onClick={sendDataReincorporacion}
                >
                  Aceptar
                </button>
